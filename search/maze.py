...
class Maze():
    ...
    def solve(self):
        ...
        frontier.add(start)  # initially will contain start state
        ...
        while True:
            ...
            if node.state == self.goal:
                actions = []
                cells = []
                # backtrack how you got to goal
                # looks through all parent nodes to get back to initial state
            ...
            # Mark node as explored (not the goal)
...
# remove show_explored to not show which paths the program explored
